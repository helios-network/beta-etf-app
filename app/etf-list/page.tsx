            ...
            <Card key={etf.id} className={s.etfCard}>
              ...
              <Card className={s.cardHeader}>
                <div className={s.etfTitle}>
                  <div className={s.titleRow}>
                    ...
                    <div className={s.titleRowRight}>
                      <h3>
                        <Link
                          href={routes.etfDetails(etf.vault)}
                ...
                <div className={s.badges}>
                  ...
                  {etf.depositCount !== undefined &&
                    etf.redeemCount !== undefined &&
                    (etf.depositCount === 0 || etf.redeemCount === 0) && (
                      <Badge status="warning">Not Tested</Badge>
                    )}
                </div>
              ...
              {etf.tokens.length > 0 ? (
                <div className={s.composition}>
                  <h4>
                    ...
                    {etf.owner &&
                      address &&
                      etf.owner.toLowerCase() === address.toLowerCase() && (
                        <Button
                          variant="secondary"
                          size="xsmall"
      ...
      {!isLoading && !error && pagination.totalPages > 1 && (
        <div className={s.pagination}>
          ...
          <Button
            ...
            disabled={
              currentPage === pagination.totalPages || !pagination.hasNextPage
            }
          />
        </div>
      )}
                  ...
                  return (
                    ...
                    >
                      ...
                      <p style={{ fontSize: "0.9rem", margin: 0 }}>
                        No rebalance is necessary at the moment. All assets are
                        aligned with their target allocations.
                      </p>
                    </div>
                  )
                }
                  ...
                  <>
                      ...
                      >
                        ...
                        >
                          ...
                          <strong>
                            $
                            {(
                              Number(rebalancePreview.totalSoldValueUSD) / 1e18
                            ).toFixed(2)}
                          </strong>
                        </div>
                        <div
                        ...
                        >
                          ...
                          <strong>
                            $
                            {(
                              Number(rebalancePreview.totalBoughtValueUSD) /
                              1e18
                            ).toFixed(2)}
                          </strong>
                        </div>
                      ...
                      >
                        ...
                        <div className={s.tokenDistributionList}>
                          {selectedETF.assets.map((asset, index) => {
                            if (index >= rebalancePreview.soldAmounts.length)
                              return null

                            const soldAmount =
                              rebalancePreview.soldAmounts[index]
                            const soldValueUSD =
                              rebalancePreview.soldValuesUSD[index]
                            ...
                            const valueNumber =
                              Number(BigInt(soldValueUSD || "0")) / 1e18

                            const logo =
                              tokenData?.[asset.symbol.toLowerCase()]?.logo

                            return (
                              <div
                                key={`sold-${asset.token}`}
                                className={s.tokenDistributionItem}
                              >
                                <div className={s.tokenInfo}>
                                  {logo ? (
                                    <Image
                                ...
                                <div className={s.tokenAmounts}>
                                  <span
                                    className={s.tokenAmount}
                                    style={{ color: "var(--danger-high)" }}
                                  >
                    ...
                    {hasBoughtAmounts && selectedETF?.assets && (
                      ...
                      >
                        ...
                        <div className={s.tokenDistributionList}>
                          {selectedETF.assets.map((asset, index) => {
                            if (index >= rebalancePreview.boughtAmounts.length)
                              return null

                            const boughtAmount =
                              rebalancePreview.boughtAmounts[index]
                            const boughtValueUSD =
                              rebalancePreview.boughtValuesUSD[index]
                            ...
                            const multiplier = BigInt(10) ** BigInt(decimals)
                            const amountNumber =
                              Number(BigInt(boughtAmount)) / Number(multiplier)
                            const valueNumber =
                              Number(BigInt(boughtValueUSD || "0")) / 1e18
                ...
                <Button
                  ...
                  disabled={
                    ...
                    (rebalancePreview &&
                      ...
                      !rebalancePreview.boughtAmounts.some(
                        (amount) => amount && amount !== "0"
                      ))
                  }
                  iconLeft={
